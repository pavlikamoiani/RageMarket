	...
	return (
		<div className="min-h-[100vh] flex flex-col justify-center items-center bg-gradient-to-br from-[#000000] via-[#000000] to-[#000000] relative px-2">
			...
			<div className="relative z-10 flex flex-col items-center w-full mb-6 md:mb-8">
				<div className="flex items-center bg-[#18181b] rounded-xl px-2 py-2 md:px-4 md:py-3 w-full max-w-[420px] shadow-lg">
					...
					/>
					<button className="ml-2 md:ml-4 px-4 py-2 rounded-lg bg-gradient-to-r from-purple-500 to-cyan-400 text-white font-medium hover:opacity-90 transition text-sm md:text-base">
						{t("find")}
					</button>
				</div>
				{/* Action buttons */}
				<div className="flex flex-col md:flex-row gap-3 md:gap-4 mt-6 md:mt-8 w-full max-w-[420px]">
					<button className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-purple-500 to-cyan-400 text-white font-semibold text-base md:text-lg shadow-lg hover:opacity-90 transition">
						{t("game_catalog")}
					</button>
					<button className="w-full px-6 py-3 rounded-lg bg-[#18181b] text-white font-semibold text-base md:text-lg border border-[#23232a] shadow-lg hover:bg-[#23232a] transition">
						{t("start_selling")}
					</button>
				</div>
			</div>
